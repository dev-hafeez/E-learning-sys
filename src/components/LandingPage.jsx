...
export default function LandingPage() {
  return (
    <>
      ...
      <h2 className="mt-[-70px] ml-[470px] text-balance text-2xl font-semibold tracking-tight text-black sm:text-3xl">
          ...
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div className="mx-auto text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <p className="mt-6 text-pretty text-lg/8 text-gray-300">
                The portal enhances academic productivity by bringing all essential academic resources into one centralized online space.
              </p>
